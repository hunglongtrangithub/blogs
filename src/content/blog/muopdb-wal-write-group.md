...
[^1]: From section 40.7, Caching and Buffering in OSTEP
...
Another approach is to use separate background threads to handle WAL sync.
...
I benchmarked the WAL write throughput before and after applying the WAL write group approach. The benchmark consists of 1000 concurrent insert requests. The results are as follows:
